    ...
    return (
        <Card onPress={() => toggleCollapse(!isCollapsed)} onLongPress={props.setActive} style={props.active ? styles.activeTask : styles.task}>
            ...
            </Card.Content>
            {
                isCollapsed &&
                <Card.Actions>
                    {props.isDone ?? <Button onPress={props.edit} color={AppTheme.secondaryDarkColor}>Edit</Button>}
                    {props.isDone ? <Button onPress={props.notDone} color={AppTheme.secondaryDarkColor}>Mark as incomplete</Button> : <Button onPress={props.done} color={AppTheme.secondaryDarkColor}>Mark as done</Button>}
